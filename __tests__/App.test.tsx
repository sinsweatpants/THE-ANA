...
vi.mock('../ai/tasks', () => ({
  ...
  executeSceneOptimization: vi.fn(),
  ...
  executeVoiceInteractionAnalysis: vi.fn(),
  executeForeshadowingDetection: vi.fn(),
  executeWhatIfScenarioAnalysis: vi.fn(),
  executeConflictDialogueGeneration: vi.fn(),

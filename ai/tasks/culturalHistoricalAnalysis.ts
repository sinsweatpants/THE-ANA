...
export const executeCulturalHistoricalAnalysis = (params: TaskRuntimeParams): Promise<GeminiServiceResponse> =>
  executeTask({
    ...params,
    taskType: TaskType.CULTURAL_HISTORICAL_ANALYZER,
    agentConfig: CULTURAL_HISTORICAL_ANALYZER_AGENT_CONFIG,
    instructions: CULTURAL_HISTORICAL_ANALYZER_INSTRUCTIONS,
  });

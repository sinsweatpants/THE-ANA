...
export const executeRecommendationsGeneration = (params: TaskRuntimeParams): Promise<GeminiServiceResponse> =>
  executeTask({
    ...params,
    taskType: TaskType.RECOMMENDATIONS_GENERATOR,
    agentConfig: RECOMMENDATIONS_GENERATOR_AGENT_CONFIG,
    instructions: RECOMMENDATIONS_GENERATOR_INSTRUCTIONS,
  });

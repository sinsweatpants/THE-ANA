...
`,
    ...
    validationRules: ["يجب أن يحتوي على قياسات كمية", "التوصيات قبلة للتطبيق"],
    outputSchema: {},
    confidenceThreshold: 0.85
};

export const executeCoreAnalysis = (params: TaskRuntimeParams): Promise<GeminiServiceResponse> =>
  executeTask({
    ...params,
    taskType: TaskType.ANALYSIS,
    agentConfig: ANALYSIS_AGENT_CONFIG,
    instructions: CORE_ANALYSIS_INSTRUCTIONS,
  });

...
export const executeTensionOptimization = (params: TaskRuntimeParams): Promise<GeminiServiceResponse> =>
  executeTask({
    ...params,
    taskType: TaskType.TENSION_OPTIMIZER,
    agentConfig: TENSION_OPTIMIZER_AGENT_CONFIG,
    instructions: TENSION_OPTIMIZER_INSTRUCTIONS,
  });

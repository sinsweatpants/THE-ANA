...
export const executeRhythmMappingAnalysis = (params: TaskRuntimeParams): Promise<GeminiServiceResponse> =>
  executeTask({
    ...params,
    taskType: TaskType.RHYTHM_MAPPING,
    agentConfig: RHYTHM_MAPPING_AGENT_CONFIG,
    instructions: RHYTHM_MAPPING_INSTRUCTIONS,
  });

...
export const executeConflictDynamicsAnalysis = (params: TaskRuntimeParams): Promise<GeminiServiceResponse> =>
  executeTask({
    ...params,
    taskType: TaskType.CONFLICT_DYNAMICS,
    agentConfig: CONFLICT_DYNAMICS_AGENT_CONFIG,
    instructions: CONFLICT_DYNAMICS_INSTRUCTIONS,
  });

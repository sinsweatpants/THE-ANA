...
export const executePlatformAdaptation = (params: TaskRuntimeParams): Promise<GeminiServiceResponse> =>
  executeTask({
    ...params,
    taskType: TaskType.PLATFORM_ADAPTER,
    agentConfig: PLATFORM_ADAPTER_AGENT_CONFIG,
    instructions: PLATFORM_ADAPTER_INSTRUCTIONS,
  });

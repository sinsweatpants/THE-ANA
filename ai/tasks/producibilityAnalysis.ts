...
export const executeProducibilityAnalysis = (params: TaskRuntimeParams): Promise<GeminiServiceResponse> =>
  executeTask({
    ...params,
    taskType: TaskType.PRODUCIBILITY_ANALYZER,
    agentConfig: PRODUCIBILITY_ANALYZER_AGENT_CONFIG,
    instructions: PRODUCIBILITY_ANALYZER_INSTRUCTIONS,
  });

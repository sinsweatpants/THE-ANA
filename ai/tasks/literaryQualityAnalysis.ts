...
export const executeLiteraryQualityAnalysis = (params: TaskRuntimeParams): Promise<GeminiServiceResponse> =>
  executeTask({
    ...params,
    taskType: TaskType.LITERARY_QUALITY_ANALYZER,
    agentConfig: LITERARY_QUALITY_ANALYZER_AGENT_CONFIG,
    instructions: LITERARY_QUALITY_ANALYZER_INSTRUCTIONS,
  });

...
export const executeCompletionTask = (params: TaskRuntimeParams): Promise<GeminiServiceResponse> =>
  executeTask({
    ...params,
    taskType: TaskType.COMPLETION,
    agentConfig: COMPLETION_AGENT_CONFIG,
    instructions: COMPLETION_MODE_INSTRUCTIONS,
  });

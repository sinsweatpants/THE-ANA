...
export const executeTargetAudienceAnalysis = (params: TaskRuntimeParams): Promise<GeminiServiceResponse> =>
  executeTask({
    ...params,
    taskType: TaskType.TARGET_AUDIENCE_ANALYZER,
    agentConfig: TARGET_AUDIENCE_ANALYZER_AGENT_CONFIG,
    instructions: TARGET_AUDIENCE_ANALYZER_INSTRUCTIONS,
  });

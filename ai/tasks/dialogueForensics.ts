...
export const executeDialogueForensicsAnalysis = (params: TaskRuntimeParams): Promise<GeminiServiceResponse> =>
  executeTask({
    ...params,
    taskType: TaskType.DIALOGUE_FORENSICS,
    agentConfig: DIALOGUE_FORENSICS_AGENT_CONFIG,
    instructions: DIALOGUE_FORENSICS_INSTRUCTIONS,
  });

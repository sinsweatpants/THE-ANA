...
export const executeVisualCinematicAnalysis = (params: TaskRuntimeParams): Promise<GeminiServiceResponse> =>
  executeTask({
    ...params,
    taskType: TaskType.VISUAL_CINEMATIC_ANALYZER,
    agentConfig: VISUAL_CINEMATIC_ANALYZER_AGENT_CONFIG,
    instructions: VISUAL_CINEMATIC_ANALYZER_INSTRUCTIONS,
  });

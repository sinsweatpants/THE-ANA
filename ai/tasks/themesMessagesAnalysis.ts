...
export const executeThemesMessagesAnalysis = (params: TaskRuntimeParams): Promise<GeminiServiceResponse> =>
  executeTask({
    ...params,
    taskType: TaskType.THEMES_MESSAGES_ANALYZER,
    agentConfig: THEMES_MESSAGES_ANALYZER_AGENT_CONFIG,
    instructions: THEMES_MESSAGES_ANALYZER_INSTRUCTIONS,
  });

...
export const executeThematicMiningAnalysis = (params: TaskRuntimeParams): Promise<GeminiServiceResponse> =>
  executeTask({
    ...params,
    taskType: TaskType.THEMATIC_MINING,
    agentConfig: THEMATIC_MINING_AGENT_CONFIG,
    instructions: THEMATIC_MINING_INSTRUCTIONS,
  });

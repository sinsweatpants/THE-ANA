...
export const executeAdaptiveRewriting = (params: TaskRuntimeParams): Promise<GeminiServiceResponse> =>
  executeTask({
    ...params,
    taskType: TaskType.ADAPTIVE_REWRITING,
    agentConfig: ADAPTIVE_REWRITING_AGENT_CONFIG,
    instructions: ADAPTIVE_REWRITING_INSTRUCTIONS,
  });

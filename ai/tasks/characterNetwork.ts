...
export const executeCharacterNetworkAnalysis = (params: TaskRuntimeParams): Promise<GeminiServiceResponse> =>
  executeTask({
    ...params,
    taskType: TaskType.CHARACTER_NETWORK,
    agentConfig: CHARACTER_NETWORK_AGENT_CONFIG,
    instructions: CHARACTER_NETWORK_INSTRUCTIONS,
  });

...
export const executeStyleFingerprintAnalysis = (params: TaskRuntimeParams): Promise<GeminiServiceResponse> =>
  executeTask({
    ...params,
    taskType: TaskType.STYLE_FINGERPRINT,
    agentConfig: STYLE_FINGERPRINT_AGENT_CONFIG,
    instructions: STYLE_FINGERPRINT_INSTRUCTIONS,
  });

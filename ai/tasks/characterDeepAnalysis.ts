...
export const executeCharacterDeepAnalysis = (params: TaskRuntimeParams): Promise<GeminiServiceResponse> =>
  executeTask({
    ...params,
    taskType: TaskType.CHARACTER_DEEP_ANALYZER,
    agentConfig: CHARACTER_DEEP_ANALYZER_AGENT_CONFIG,
    instructions: CHARACTER_DEEP_ANALYZER_INSTRUCTIONS,
  });
